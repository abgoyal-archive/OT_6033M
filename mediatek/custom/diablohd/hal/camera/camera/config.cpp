...
/*=========|==============|============================|==========================================*/
/*03/28/13 |Yuan Xiang    |PR429683-Yuanxiang-001 | No “Maker”and “Model”in image details screen*/
/*=========|==============|============================|==========================================*/
...
//PR429683-yuanxiang-begin-001
#define LOG_TAG "custm_SetExif"
#include <utils/Log.h>
//PR429683-yuanxiang-end-001
...
//PR305658-Jun 18,2012-yanlong.li@jrdcom.com -start-002
MINT32 custom_SetExif(void **ppCustomExifTag)
{
#ifdef EN_CUSTOM_EXIF_INFO
    char model[32];
...
#define FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X 40
