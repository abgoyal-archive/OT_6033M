...
Shading:{
    {set:{//00 Preview
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0x9050903C,0x00583220,0x0052003F,0x20202020,
    }},
    {set:{//01 Capture
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0xF064F04B,0x005C8020,0x0066004E,0x20202020,
    }},
    {set:{//02
...
NR2:{
    ...
    {set:{//03 Preview ISO800
        0x00200000, 0x00191414, 0x00D27768, 0x09111925, 0x101F2D41, 0x0110728E, 0x08080808, 0x10101010, 0x01AF5B48, 0x0000056B, 0x060B1119, 
    }},
    {set:{//04 Preview ISO1600
...
EE:{// EE
    ...
    {set:{//03 Preview ISO800 (middle sharpness)
        0x00000028, 0x0037372C, 0x000F0063, 0x00ED0495, 0x013401BD, 0x015200E5, 0xFFFFFB0D, 
    }},
...
Saturation:{
    {set:{//00 (middle saturation)
        0x00010709, 0x1020E0F0, 0x36505650, 0x36000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//01 (middle saturation)
        0x00010708, 0x1020E0F0, 0x36505650, 0x36000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//02 (middle saturation)
        0x00010709, 0x1020E0F0, 0x284A4C4A, 0x28000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//03 (middle saturation)
        0x00010708, 0x1020E0F0, 0x20404540, 0x20000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//04 (middle saturation)
        0x00010709, 0x1020E0F0, 0x1E3C403C, 0x1E000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    ...
    {set:{//06 no one uses this, this is Max Sat. (high saturation)
        0x00000709, 0x1020E0F0, 0x4F4F4F4F, 0x4F000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }}
            },
Contrast:{
    //..........................................................................
...
CCM:{
    {set:{//00
        0x01800479, 0x04070478, 0x0186040E, 0x0443059A, 0x02DD0000, 
    }},
    {set:{//01
        0x0264054F, 0x04150483, 0x01BA0437, 0x041004F7, 0x02070000, 
    }},
    {set:{//02
        0x0204050B, 0x0007044F, 0x01AB045C, 0x040204D1, 0x01D30000, 
    }}
            },
Gamma:{
    {set:{//00
        0x4427150B, 0x8C7E6E5C, 0xC1B3A398, 0xE4DDD5CC, 0xFCFAF4F0, 
    }},
            }
