...
#ifdef S5K8AAYX_72M_PCLK
	#define S5K8AAYX_VID_NOM_FIX_FPS			250		// 25fps,can't reach 30fps
#else
...
#define S5K8AAYX_SXGA_PERIOD_PIXEL_NUMS               2175         /* 2175 */
#define S5K8AAYX_SXGA_PERIOD_LINE_NUMS                1607         /* 1607 */
...
//#define S5K8AAYX_WRITE_ID		0x5A		
//#define S5K8AAYX_READ_ID		0x5B
#define S5K8AAYX_WRITE_ID		0x78		
#define S5K8AAYX_READ_ID		0x79
//#define S5K8AAYX_WRITE_ID		0x7A		
//#define S5K8AAYX_READ_ID		0x7B
#else
