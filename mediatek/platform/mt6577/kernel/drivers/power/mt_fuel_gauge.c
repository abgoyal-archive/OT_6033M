...
BATTERY_PROFILE_STRUC_P fgauge_get_profile(kal_uint32 temperature)
{
    switch (temperature)
    {
        case TEMPERATURE_T0:
	     ...
	     if(battery_id_check==1)
            return &battery_profile_t0[0];
	     else  
	     return &lishen_battery_profile_t0[0];               
#else 
	     if(battery_id_check==1)
            return &battery_profile_t0[0];
	     else  
        ...
        case TEMPERATURE_T1:
	     ...
	     return &lishen_battery_profile_t1[0];    
#else
	     if(battery_id_check==1)
            return &battery_profile_t1[0];
	     else  
        ...
        case TEMPERATURE_T2:
	     ...
	     return &lishen_battery_profile_t2[0];    
#else
	     if(battery_id_check==1)
            return &battery_profile_t2[0];
	     else  
        ...
        case TEMPERATURE_T3:
	     ...
	     return &lishen_battery_profile_t3[0];    
#else
	     if(battery_id_check==1)
            return &battery_profile_t3[0];
	     else  
...
kal_int32 fgauge_get_Q_max(kal_int16 temperature)
{
	...
	{
		low_Q_max = LISHEN_Q_MAX_NEG_10;
       	high_Q_max = LISHEN_Q_MAX_POS_0;
	} 
#else 
            if(battery_id_check==1)
	{
	...
	{
		low_Q_max = LISHEN_Q_MAX_POS_0;
       	high_Q_max = LISHEN_Q_MAX_POS_25;
	} 
#else 
            if(battery_id_check==1)
	{
	...
	{
		low_Q_max = LISHEN_Q_MAX_POS_25;
       	high_Q_max = LISHEN_Q_MAX_POS_50;
	} 
#else 
            if(battery_id_check==1)
	{
...
kal_int32 fgauge_get_Q_max_high_current(kal_int16 temperature)
{
	...
	{
		low_Q_max = LISHEN_Q_MAX_NEG_10_H_CURRENT;
	       high_Q_max = LISHEN_Q_MAX_POS_0_H_CURRENT;
	}
#else 
             if(battery_id_check==1)
	{
	...
	{
		low_Q_max = LISHEN_Q_MAX_POS_0_H_CURRENT;
	       high_Q_max = LISHEN_Q_MAX_POS_25_H_CURRENT;
	}
#else 
             if(battery_id_check==1)
	{
	...
	{
		low_Q_max = LISHEN_Q_MAX_POS_25_H_CURRENT;
	       high_Q_max = LISHEN_Q_MAX_POS_50_H_CURRENT;
	}
#else 
             if(battery_id_check==1)
	{
...
{    
	...
	{
	gFG_BATT_CAPACITY_init_high_current = LISHEN_Q_MAX_POS_25_H_CURRENT;
    //gFG_BATT_CAPACITY_aging = gFG_BATT_CAPACITY_init_high_current;
    gFG_BATT_CAPACITY_aging = LISHEN_Q_MAX_POS_25;
	}
#else 
    if(battery_id_check==1)
	{
